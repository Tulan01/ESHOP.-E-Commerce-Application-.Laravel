			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{route('allcatagory')}}"><i class="icon-envelope"></i><span class="hidden-tablet"> All Catagory</span></a></li>
						<li><a href="{{route('addcatagory')}}"><i class="icon-tasks"></i><span class="hidden-tablet">Add Catagory</span></a></li>
						<li><a href="{{route('allbrand')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Brands</span></a></li>
						<li><a href="{{route('addbrand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Brands</span></a></li>
						<li>
						...
						<li><a href="{{route('manageorder')}}"><i class="icon-font"></i><span class="hidden-tablet">Manage Order</span></a></li>
